function loadedCnt = findSlddLoadSigXCU(path, varargin)
%%
% 目的: 导入sldd表格中的Signal
% 输入：
%       path: sldd path
% 返回： loadedCnt: 成功导入的数据条数
% 范例： findSlddLoadSigXCU('TmComprCtrl_DD_PCMU.xlsx')
% 作者： Blue.ge
% 日期： 20240201
%% 
    clc
    ...
    for i=1:sz(1)
        ...
        sig_create_station = strcat(sig_attributes.Name, '=' ,'GCSC.Signal',';');
