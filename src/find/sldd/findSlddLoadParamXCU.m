function loadedCnt = findSlddLoadParamXCU(path, varargin)
%%
...
% 范例： findSlddLoadParamXCU('TmComprCtrl_DD_XCU.xlsx')
% 作者： Blue.ge
% 日期： 20240201
%% 
    clc
    ...
    for i=1:sz(1)
        ...
        para_create_station = strcat(para_attributes.Name, '=' , 'GCSC.Parameter',';');
