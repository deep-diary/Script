function  nums = createGotoBasedOnUselessFrom(varargin)
%%
...
%       step： 信号间隔步长， 默认为30
% 返回：已经成功创建的记录数量
% 范例：numCreated = createGotoBasedOnUselessFrom('posBase', [12500,0])
...
%%
    ...
    addParameter(p,'type','constant');      % 设置变量名和默认参数 constant, ground
