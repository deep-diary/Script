function [inList, outList] = createPortsTagUpdate(varargin)
%%
...
%       outputStep：输出端口步长
% 返回：成功创建好的信号
% 范例： createPortsTagUpdate('posIn', [100 100], 'inList',{}),
% 作者： Blue.ge
% 日期： 20231114
%%
    clc
...
%     addParameter(p,'keepName',false);      % 设keepNameults.wid;
...
%     keepName = p.Results.keepName;
    ...
    createPortsGoto('outList', outList, 'posOut',maxOutPos(1:2) + [0 30], ...
        'mode',mode)
    %% 改变模型大小
