...
%   版本: 1.1
    ...
    try
        ...
        for i = 1:length(portsIn)
            ...
            set_param(gotoBlock,'AttributesFormatString','%<GotoTag>');
            set_param(gotoBlock,'BackgroundColor','magenta')
            % 创建连线
        ...
        for i = 1:length(portsOut)
            ...
            set_param(fromBlock,'AttributesFormatString','%<GotoTag>');
            set_param(fromBlock,'BackgroundColor','yellow')
